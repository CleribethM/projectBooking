/*SCRIPT A INGRESAR EN LA BASE DE DATOS*/
#4 categorias
INSERT INTO hospedajes.category ( title,description, url) VALUES ('Hotel',  '123.587 Hoteles', 'https://www.palladiumhotelgroup.com/content/dam/palladium/content-fragments/hoteles/es/trs-ibiza-hotel/galeria/imagenes/hotel/02-TRS-IBIZA-PISCINA-GAIA_MG_6077-min.jpg.transform/rendition-md/image.jpg');
INSERT INTO hospedajes.category ( title,description, url) VALUES ('Hostel', '12.580 Hostels', 'https://descubreteviajando.com/wp-content/uploads/2016/09/001.jpg');
...
#20 ciudades
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Cordoba','Villa General Belgrano', 5194);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Buenos Aires','Mar del Plata', 7600);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Rio Negro','Bariloche',8400);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Salta','Salta',4400);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Misiones','Iguazú', 3370);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Santa Fe','Rosario',2000);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Santa Cruz','El Calafate',9405);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Buenos Aires','Tandil',7000);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Tierra del Fuego','Ushuaia',9410);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Argentina','Neuquén','San Martin de los Andes',8370);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Magdalena','Santa Marta', 47001);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Cundinamarca','Bogota', 110110);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Bolivar','Cartagena', 30201);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Atlantico','Barranquilla', 080001);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Santander','Bucaramanga', 680001);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Santander','Cúcuta', 540001);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Córdoba','Montería', 230001);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Quindio','Armenia', 630001);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','Bahia Solano','Chocó', 274057);
INSERT INTO hospedajes.city (country,location,name,postal_code) VALUES ('Colombia','La Guajira','Riohacha', 440001);

#7 caracteristicas
INSERT INTO hospedajes.feature(name, icon) values('Televisor', 'faTv');
INSERT INTO hospedajes.feature(name, icon) values('Cocina','faKitchenSet');
INSERT INTO hospedajes.feature(name, icon) values('Estacionamiento gratuito', 'faCar');
INSERT INTO hospedajes.feature(name, icon) values('Apto mascotas', 'faPaw');
INSERT INTO hospedajes.feature(name, icon) values('Aire acondicionado','faSnowflake');
INSERT INTO hospedajes.feature(name, icon) values('Pileta', 'faPersonSwimming');
INSERT INTO hospedajes.feature(name, icon) values('Wifi', 'faWifi');


INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Nuevo Horizonte', 'Alojate en uno de los mas exclusivos de la zona', 'Exclusivo hotel en el centro de una ciudad unica. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-out: 11:00. No fumar. No se permiten fiestas ', ' Se aplican las prácticas de seguridad contra la COVID-19. No consta que el alojamiento tenga un detector de humo ', ' Reembolso completo: recupera el 100 % de lo que pagaste.', 8, 11, 1);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Hotel Hermitage', 'Con vista al mar', 'Exclusivo hotel en el centro de una ciudad unica. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-out: 11:00 No fumar. No se permiten fiestas', ' Se aplican las prácticas de seguridad contra la COVID-19. No consta que el alojamiento tenga un detector de humo ', ' Reembolso completo: recupera el 100 % de lo que pagaste.', 7, 2, 1);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Hotel del golf', 'Excelente ubicación', 'Exclusivo hotel en el centro de una ciudad unica. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-out: 11:00 No fumar. No se permiten fiestas', ' Se aplican las prácticas de seguridad contra la COVID-19. No consta que el alojamiento tenga un detector de humo ', ' Reembolso completo: recupera el 100 % de lo que pagaste.', 9, 11, 1);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Hotel NH', 'Ideal para disfrutar en familia', 'Exclusivo hotel en el centro de una ciudad unica. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-out: 11:00 No fumar.', ' Se aplican las prácticas de seguridad contra la COVID-19. No consta que el alojamiento tenga un detector de humo ', ' Reembolso completo: recupera el 100 % de lo que pagaste.', 7, 8, 1);


INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Casona del Sol', 'Hostel para disfrutar la naturaleza', 'Armonioso hostel en el corazon de la naturaleza, podras disfrutar de una vista increible junto al confort que ofrece esta apasionante opcion. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-in: 10:00 a 11:00 hs. No se admiten mascotas', ' Cámara de seguridad/dispositivo de grabación. Detector de humo', ' Consulta la política de cancelación completa ', 7, 2, 2);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Acantilados Hostel', 'Hostel para disfrutar con amigos', 'Armonioso hostel en el corazon de la naturaleza, podras disfrutar de una vista increible junto al confort que ofrece esta apasionante opcion. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-in: 10:00 a 11:00 hs. No se admiten mascotas', ' Cámara de seguridad/dispositivo de grabación. Detector de humo', ' Consulta la política de cancelación completa ', 7, 5, 2);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Hostel La puerta', 'Hostel con excelente ubicación', 'Armonioso hostel en el corazon de la naturaleza, podras disfrutar de una vista increible junto al confort que ofrece esta apasionante opcion. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-in: 10:00 a 11:00 hs. No se admiten mascotas', ' Cámara de seguridad/dispositivo de grabación. Detector de humo', ' Consulta la política de cancelación completa ', 9, 11, 2);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Hostel Puerto Alegre', 'Hostel a dos cuadras del mar', 'Armonioso hostel en el corazon de la naturaleza, podras disfrutar de una vista increible junto al confort que ofrece esta apasionante opcion. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-in: 10:00 a 11:00 hs. No se admiten mascotas', ' Cámara de seguridad/dispositivo de grabación. Detector de humo', ' Consulta la política de cancelación completa ', 10, 8, 2);


INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Departamento Luxury', 'Departamento exclusivo', 'Increible departamento con todas las comodidades que uno necesita para una estadia mas que confortable. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-in: 14:00 hs. Check-out: 16:00 hs. Prohibido fumar. No se permiten fiestas o eventos', ' Alarma de monoxido de carbono. Alarma de humo', ' Esta reserva no es reembolsable. Consulta la política de cancelación completa del anfitrión', 9,11, 3);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Sucre suitis', 'Departamento con vista al mar', 'Increible departamento con todas las comodidades que uno necesita para una estadia mas que confortable. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-in: 14:00 hs. Check-out: 16:00 hs. Prohibido fumar. No se permiten fiestas o eventos', ' Alarma de monoxido de carbono. Alarma de humo', ' Esta reserva no es reembolsable. Consulta la política de cancelación completa del anfitrión', 7,5, 3);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Recoleta Apartment', 'Departamento con excelente ubicación', 'Increible departamento con todas las comodidades que uno necesita para una estadia mas que confortable. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-in: 14:00 hs. Check-out: 16:00 hs. Prohibido fumar. No se permiten fiestas o eventos', ' Alarma de monoxido de carbono. Alarma de humo', ' Esta reserva no es reembolsable. Consulta la política de cancelación completa del anfitrión', 7,12, 3);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Luxury Loft', 'Departamento calido y luminoso', 'Increible departamento con todas las comodidades que uno necesita para una estadia mas que confortable. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Check-in: 14:00 hs. Check-out: 16:00 hs. Prohibido fumar. No se permiten fiestas o eventos', ' Alarma de monoxido de carbono. Alarma de humo', ' Esta reserva no es reembolsable. Consulta la política de cancelación completa del anfitrión', 8,8, 3);


INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation, city_id, category_id) VALUES ('Casa balcón', 'Armonioso bed and breakfast', ' Todas nuestras habitaciones  tienen terraza y vistas panorámicas a la ciudad. Destacamos el confort y el buen gusto. Cuidamos el más mínimo detalle, haciendo de tu estancia una visita inolvidable. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Llegada: 15:00 a 23:00. No se admiten mascotas. No se permite fiestas y/o eventos. Prohibido fumar', 'No hay alarma de monóxido de carbono. Alarma de humos', ' Consulta la política de cancelación completa del anfitrión', 7, 5, 4);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation, city_id, category_id) VALUES ('Barcelona B&B', 'Sentite comodo y a gusto en este bed and breakfast', ' Todas nuestras habitaciones  tienen terraza y vistas panorámicas a la ciudad. Destacamos el confort y el buen gusto. Cuidamos el más mínimo detalle, haciendo de tu estancia una visita inolvidable. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Llegada: 15:00 a 23:00. No se admiten mascotas. No se permite fiestas y/o eventos. Prohibido fumar', 'No hay alarma de monóxido de carbono. Alarma de humos', ' Consulta la política de cancelación completa del anfitrión', 9, 11, 4);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation, city_id, category_id) VALUES ('Casa Urban B&B', 'Exclusivo bed and breakfast', ' Todas nuestras habitaciones  tienen terraza y vistas panorámicas a la ciudad. Destacamos el confort y el buen gusto. Cuidamos el más mínimo detalle, haciendo de tu estancia una visita inolvidable. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Llegada: 15:00 a 23:00. No se admiten mascotas. No se permite fiestas y/o eventos. Prohibido fumar', 'No hay alarma de monóxido de carbono. Alarma de humos', ' Consulta la política de cancelación completa del anfitrión', 8, 12, 4);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation, city_id, category_id) VALUES ('Casona del sol B&B', 'Bed and breakfast para disfrutar en familia', ' Todas nuestras habitaciones  tienen terraza y vistas panorámicas a la ciudad. Destacamos el confort y el buen gusto. Cuidamos el más mínimo detalle, haciendo de tu estancia una visita inolvidable. Cuenta con recepción 24 horas, servicio de conserjería y WiFi gratuita en todas las instalaciones. El hotel ofrece habitaciones familiares.', 'Llegada: 15:00 a 23:00. No se admiten mascotas. No se permite fiestas y/o eventos. Prohibido fumar', 'No hay alarma de monóxido de carbono. Alarma de humos', ' Consulta la política de cancelación completa del anfitrión', 10, 8, 4);
...
insert into hospedajes.role (role)  values("USER");
insert into hospedajes.role (role)  values("ADMIN");
insert into hospedajes.client (email,last_name,name,password,role_id) values("adiministrador@admin.com","usuario","administrador","$2a$10$56VCAiApLO8NQYeOPiu2De/EBC5RWrTZvLl7uoeC3r7iXinRR1iiq",2);
insert into hospedajes.client (email,last_name,name,password,role_id) values("usuario@admin.com","usuario","usuario","$2a$10$56VCAiApLO8NQYeOPiu2De/EBC5RWrTZvLl7uoeC3r7iXinRR1iiq",1);

select*from hospedajes.client
...
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Nuevo Hotizonte', 'Alojate en uno de los mas exclusivos de la zona', 'Exclusivo hotel en el centro de una ciudad unica', 'Check-out: 11:00. No fumar. No se permiten fiestas ', ' Se aplican las prácticas de seguridad contra la COVID-19. No consta que el alojamiento tenga un detector de humo ', ' Reembolso completo: recupera el 100 % de lo que pagaste.', 8, 11, 1);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Hotel Hermitage', 'Con vista al mar', 'Exclusivo hotel en el centro de una ciudad unica', 'Check-out: 11:00 No fumar. No se permiten fiestas', ' Se aplican las prácticas de seguridad contra la COVID-19. No consta que el alojamiento tenga un detector de humo ', ' Reembolso completo: recupera el 100 % de lo que pagaste.', 7, 2, 1);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Hotel del golf', 'Excelente ubicación', 'Exclusivo hotel en el centro de una ciudad unica', 'Check-out: 11:00 No fumar. No se permiten fiestas', ' Se aplican las prácticas de seguridad contra la COVID-19. No consta que el alojamiento tenga un detector de humo ', ' Reembolso completo: recupera el 100 % de lo que pagaste.', 9, 11, 1);
...
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Acantilados Hostel', 'Hostel para disfrutar con amigos', 'Armonioso hostel en el corazon de la naturaleza, podras disfrutar de una vista increible junto al confort que ofrece esta apasionante opcion', 'Check-in: 10:00 a 11:00 hs. No se admiten mascotas', ' Cámara de seguridad/dispositivo de grabación. Detector de humo', ' Consulta la política de cancelación completa ', 7, 5, 2);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Hostel La puerta', 'Hostel con excelente ubicación', 'Armonioso hostel en el corazon de la naturaleza, podras disfrutar de una vista increible junto al confort que ofrece esta apasionante opcion', 'Check-in: 10:00 a 11:00 hs. No se admiten mascotas', ' Cámara de seguridad/dispositivo de grabación. Detector de humo', ' Consulta la política de cancelación completa ', 9, 11, 2);
...
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Recoleta Apartment', 'Departamento con excelente ubicación', 'Increible departamento con todas las comodidades que uno necesita para una estadia mas que confortable', 'Check-in: 14:00 hs. Check-out: 16:00 hs. Prohibido fumar. No se permiten fiestas o eventos', ' Alarma de monoxido de carbono. Alarma de humo', ' Esta reserva no es reembolsable. Consulta la política de cancelación completa del anfitrión', 7,12, 3);
INSERT INTO hospedajes.product (title, title_description, description, house_rules, health_and_safety, cancellation_policies, punctuation,city_id, category_id) VALUES ('Luxury Loft', 'Departamento calido y luminoso', 'Increible departamento con todas las comodidades que uno necesita para una estadia mas que confortable', 'Check-in: 14:00 hs. Check-out: 16:00 hs. Prohibido fumar. No se permiten fiestas o eventos', ' Alarma de monoxido de carbono. Alarma de humo', ' Esta reserva no es reembolsable. Consulta la política de cancelación completa del anfitrión', 8,8, 3);
...
insert into hospedajes.booking (`start_date`, end_date, product_id, client_id) values('2022-01-01','2022-02-02',1, 2);
insert into hospedajes.booking (`start_date`, end_date, product_id, client_id) values('2022-03-01','2022-02-02',1, 2);
insert into hospedajes.booking (`start_date`, end_date, product_id, client_id) values('2022-04-01','2022-05-02',2, 2);
insert into hospedajes.booking (`start_date`, end_date, product_id, client_id) values('2022-08-01','2022-09-02',3, 2);
insert into hospedajes.booking (`start_date`, end_date, product_id, client_id) values('2022-09-01','2022-10-02',4, 2);
insert into hospedajes.booking (`start_date`, end_date, product_id, client_id) values('2022-01-01','2022-03-02',5, 2);
*/